...
- We add CLIP text model to embed the instruction ('human' part of the conversation). This module is highly lightweight (123M) compared to the language model, adding negligible compute overhead.
